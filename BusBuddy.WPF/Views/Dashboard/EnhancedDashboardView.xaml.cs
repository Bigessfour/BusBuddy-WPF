    ...
    public partial class EnhancedDashboardView : UserControl
    {
        ...
        public EnhancedDashboardView()
        {
            try
            {
                ...
                if (_isInitializing)
                {
                    throw new InvalidOperationException("EnhancedDashboardView is already initializing. Nested initialization calls are not allowed.");
                }
                ...
                {
                    _logger?.LogError(initEx, "InitializeComponent failed, creating fallback UI");
                    CreateFallbackUI();
                    return;
                }
